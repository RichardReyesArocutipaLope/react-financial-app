...
export const { addRole, setLoadingRoles, updateRoles, setRoles, deleteRoleById,
    clearRolesLogout, setAdministradores, setAnalistas, setCajeros, setCobradores } = rolesSlice.actions
