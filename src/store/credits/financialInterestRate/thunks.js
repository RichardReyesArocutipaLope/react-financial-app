...
import { clearFinancialInterestRateLogout, setFinancialInterestRate, setLoadingFinancialInterestRate } from "./financialInterestRateSlice";

export const startLoadingFinancialInterestRate = () => {
    return async (dispatch) => {
        dispatch(setLoadingFinancialInterestRate());
        const { ok, financialInterestRate, errorMessage } = await financialInterestRateGetRequest();
