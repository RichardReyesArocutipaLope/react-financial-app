    ...
    return (
        <DocumentTemplate>
            ...
            <RowForDocument margin='1.2'>
                ...
                <InputForDocument col={9} label='Dirección'
            ...
            <RowForDocument margin='1.2'>
                ...
                <InputForDocument col={10} label='Correo' content={creditRawSelected?.fk_customer?.email || 'No especificado'} />
            </RowForDocument>

            <h2 className="client-file__subtitle">Datos del negocio</h2>
            <RowForDocument margin='1.2'>
                <InputForDocument col={12} label='Dirección de negocio' content={creditRawSelected?.fk_customer?.business.address} />
            ...
            <RowForDocument margin='1.2'>
                <InputForDocument col={24} label='Actividad de negocio' textarea
            ...
            <RowForDocument margin='1.2'>
                ...
                <InputForDocument col={10} label='Correo'
