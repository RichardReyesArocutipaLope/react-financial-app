		...
		<DocumentTemplate>
			...
			<RowForDocument margin='1.2'>
				...
				<InputForDocument
					col={7}
					label='Celular 2'
					content={creditRawSelected?.fk_customer?.phone2 || 'No especificado'}
				/>
				<InputForDocument
					col={10}
					label='Correo'
					content={creditRawSelected?.fk_customer?.email || 'No especificado'}
				/>
			</RowForDocument>
			...
			<RowForDocument margin='1.2'>
				<InputForDocument
					...
					content={creditRawSelected?.fk_customer?.business.address}
				/>
				<InputForDocument
					col={12}
			...
			<RowForDocument margin='1.2'>
				<InputForDocument
					col={9}
					label='Nombres'
					content={`${creditRawSelected?.aval[0]?.first_name || ''} ${
						creditRawSelected?.aval[0]?.last_name || 'No especificado'
					}`}
				/>
				<InputForDocument
					col={5}
