...
import { labelTabsHeader } from '../createCredit/dataCreateCredit';
...
export const EditCredit = ({ setIsOpenModal, modalReset, modalSubmit }) => {
	...
	useEffect(() => {
		if (validForm) {
			...
			handleSubmit(data => dispatch(startUpdateCredit(data, creditFormEdit?.id)))();
		}
	}, [validForm]);
