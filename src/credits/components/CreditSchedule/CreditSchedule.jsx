            ...
            <div className='document__info-container'>
                <div className='document__info'>
                    ...
                    <div>
                        ...
                        <p><span>Phone</span>: {creditRawSelected?.fk_customer?.phone}</p>
                        <p><span>Email</span>: {creditRawSelected?.fk_customer?.email || 'No especificado'}</p>
                    </div>
                </div>
                <div className='document__info'>
                    <div>
                        <p><span>Invoice No</span>: 345232</p>
                        <p><span>Invoice Date</span>: {moment(creditRawSelected?.date_of_issue).format('YYYY-MM-DD')}</p>
                    </div>
                    <div>
                        <p><span>Contact Person</span></p>
                        <p><span>Account ID</span>: 235432 3452 23452</p>
                        <p><span>Account Name</span>: {creditRawSelected?.fk_customer.first_name + ' ' + creditRawSelected?.fk_customer.last_name}</p>
                    </div>
                </div>
            </div>
