		...
		<div className='dashboard'>
			...
			<div className='tools-container'>
				<div className='social-container'>
					<a
						href='https://github.com/RichardReyesArocutipaLope'
						target='_blank'
						className='social-icon' rel="noreferrer">
				...
				<MirrorCard width='30rem' height='45rem'>
					<div className='tools'>
						...
						<a
							...
							target='_blank'
							className='tools__repository' rel="noreferrer">
							{' '}
							<i className='fa-brands fa-github'></i> Repositorio
						</a>
						<p className='tools__description'>
							El Front End posee validación de formularios, exportaciones, modo
							oscuro y diseño responsivo. Se uso Redux Toolkit, axios y todos
							los componentes son propios y desarrollados con puro CSS
						</p>
					</div>
				</MirrorCard>
				<span className='tools__plus'>
				...
				<MirrorCard width='30rem' height='45rem'>
					<div className='tools'>
						...
						<p className='tools__description'>
							Esta API usa PostgreSQL, posee authenticacion con JWT, control de
							usuarios mediante roles y permisos y para la manipulacion de datos
							se usa TypeORM.
						</p>
					</div>
				</MirrorCard>
			...
			<ShadowCard width='100%' height='max-content'>
				<div className='db-logical'>
					<h2 className='db-logical__title'>
						Modelo lógico de la base de datos {'(primera versión)'}
					</h2>
					<div>
