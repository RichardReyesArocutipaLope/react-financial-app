...
export const ModuleOption = ({ moduleOptionData, moduleOptionModal, handleModal }) => {
    ...
    const onClickModuleOption = () => {
        if (!idIsRequired) return handleModal('setData', modalBodyComponent, modalFooterComponent, modalProperties,)
        if (selectedCredit?.id) return handleModal('setData', modalBodyComponent, modalFooterComponent, modalProperties,)
