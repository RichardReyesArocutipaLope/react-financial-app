...
export const Sidebar = () => {
	...
	const cssLightTheme = {
		...
		'--shadow-sidebar-footer-button':
			' 4px 4px 10px 0px var(--shadow-60), -2px -2px 4px 0px rgb(240, 240, 240), inset -2px -2px 2px 0px rgb(20, 20, 20), inset 2px 2px 2px 0px rgb(75, 75, 75)',
		'--bg-change-theme': ' rgb(215, 215, 215)',
		'--bg-button-change-theme':
			' linear-gradient(315deg, #000000 0%, #414141 70%)',
		'--shadow-change-theme1':
			' -4px -4px 8px 0px rgb(245, 245, 245), 4px 4px 10px 0px var(--shadow-45), inset -2px -2px 2px 0px var(--shadow-25), inset 2px 2px 2px 0px rgb(245, 245, 245)',
		'--shadow-change-theme2':
			' 2px 3px 2px 0px rgb(245, 245, 245), -2px -2px 3px 0px var(--shadow-25), inset 5px 5px 10px 2px var(--shadow-20)',
		'--bg-sidebar-option': ' rgb(215, 215, 215)',
		'--color-sidebar-option': ' rgb(70, 70, 70)',
		'--bg-sidebar-option-hover': ' rgb(225, 225, 225)',
		'--shadow-sidebar-option-hover':
			' -4px -4px 8px 0px rgb(230, 230, 230), 4px 4px 10px 0px var(--shadow-40), inset -2px -2px 2px 0px var(--shadow-15), inset 2px 2px 3px 0px rgb(235, 235, 235)',
		'--bg-sidebar-option-active': ' rgb(40, 40, 40)',
		'--color-sidebar-option-active': ' rgb(220, 220, 220)',
		'--shadow-sidebar-option-active':
			' 4px 4px 13px 0px var(--shadow-50), -3px -3px 4px 0px rgb(230, 230, 230), inset -3px -3px 5px 0px rgb(20, 20, 20), inset 3px 3px 5px 0px rgb(65, 65, 65)',
		...
		'--shadow-sidebar-suboption-hover':
			' -4px -4px 4px 0px rgb(225, 225, 225), 4px 4px 5px 0px var(--shadow-20), inset -2px -2px 2px 0px var(--shadow-15), inset 2px 2px 3px 0px rgb(235, 235, 235)',
		'--bg-sidebar-suboption-active': ' rgb(40, 40, 40)',
		'--color-sidebar-suboption-active': ' rgb(220, 220, 220)',
		'--shadow-sidebar-suboption-active':
			' 4px 4px 5px 0px var(--shadow-40), -3px -3px 4px 0px rgb(230, 230, 230), inset -3px -3px 5px 0px rgb(20, 20, 20), inset 3px 3px 5px 0px rgb(65, 65, 65)',
		...
		'--shadow-module-option-wrapper':
			' .3rem .3rem .3rem 0rem var(--shadow-40), inset -.15rem -.15rem .1rem 0rem rgb(180, 180, 180), inset .15rem .15rem .1rem 0rem rgb(240, 240, 240)',
		'--bg-module-option': ' rgb(215, 215, 215)',
		'--color-module-option': ' rgb(70, 70, 70)',
		'--color-module-option-active': ' rgb(40, 40, 40)',
		'--shadow-module-option':
			' inset .2rem .2rem .6rem 0rem var(--shadow-50), .15rem .15rem .1rem 0rem rgb(240, 240, 240), -.15rem -.15rem .1rem 0rem rgb(180, 180, 180)',
		'--shadow-module-option-active':
			' inset .6rem .6rem 1.5rem 0rem var(--shadow-50), .15rem .15rem .1rem 0rem rgb(240, 240, 240), -.15rem -.15rem .1rem 0rem rgb(180, 180, 180)',
		...
		'--bg-table-tr-hover': ' rgb(80, 80, 80)',
		'--bg-table-tr-active': ' rgb(40, 40, 40)',
		...
		'--shadow-pagination-button-active':
			' .3rem .3rem .8rem 0rem var(--shadow-15)',
		...
		'--shadow-document':
			' -.5rem -.5rem .8rem 0 rgb(235, 235, 235), 1.5rem 1.5rem 1rem 0rem var(--shadow-20), inset .3rem .3rem .2rem 0 rgb(230, 230, 230), inset -.3rem -.3rem .2rem 0 rgb(180, 180, 180)',
	...
	const cssDarkTheme = {
		...
		'--shadow-sidebar-footer-button':
			'-2px -2px 4px 0px rgb(10, 10, 10),inset -3px -3px 3px 0px rgb(10, 10, 10),inset 3px 3px 3px 0px rgb(40, 40, 40)',
		'--bg-change-theme': 'rgb(30, 30, 30)',
		'--bg-button-change-theme':
			'linear-gradient(315deg, #000000 0%, #414141 70%)',
		'--shadow-change-theme1':
			'-4px -4px 10px 0px rgb(10, 10, 10), inset -2px -2px 2px 0px rgb(10, 10, 10),inset 2px 2px 2px 0px rgb(40, 40, 40)',
		'--shadow-change-theme2':
			'2px 3px 2px 0px rgb(40, 40, 40), -2px -2px 3px 0px var(--shadow-85),inset 5px 5px 10px 2px var(--shadow-90)',
		'--bg-sidebar-option': 'rgb(0, 0, 0)',
		'--color-sidebar-option': 'rgb(170, 170, 170)',
		'--bg-sidebar-option-hover': 'rgb(10, 10, 10)',
		'--shadow-sidebar-option-hover':
			'-4px -4px 8px 0px rgb(10, 10, 10), inset -3px -3px 3px 0px rgb(3, 3, 3),inset 3px 3px 3px 0px rgb(20, 20, 20)',
		'--bg-sidebar-option-active': 'rgb(30, 30, 30)',
		'--color-sidebar-option-active': 'rgb(170, 170, 170)',
		'--shadow-sidebar-option-active':
			'-3px -3px 4px 0px rgb(10, 10, 10), inset -3px -3px 5px 0px rgb(10, 10, 10), inset 3px 3px 5px 0px rgb(40, 40, 40)',
		...
		'--shadow-sidebar-suboption-hover':
			' -4px -4px 4px 0px rgb(10, 10, 10),inset 2px 2px 3px 0px rgb(3, 3, 3)',
		...
		'--shadow-module-option-wrapper':
			'.3rem .3rem .3rem 0rem var(--shadow-80), inset -.15rem -.15rem .1rem 0rem rgb(0, 0, 0), inset .15rem .15rem .1rem 0rem rgb(10, 10, 10)',
		'--bg-module-option': 'rgb(0, 0, 0)',
		'--color-module-option': 'rgb(170, 170, 170)',
		'--color-module-option-active': 'rgb(200, 200, 200)',
		'--shadow-module-option':
			'inset .2rem .2rem .6rem 0rem var(--shadow-80), .15rem .15rem .1rem 0rem rgb(12, 12, 12), -.15rem -.15rem .1rem 0rem rgb(0, 0, 0)',
		'--shadow-module-option-active':
			'inset .6rem .6rem 1.5rem 0rem var(--shadow-100), .15rem .15rem .1rem 0rem rgb(12, 12, 12), -.15rem -.15rem .1rem 0rem rgb(0, 0, 0)',
		...
		'--bg-table-tr-active': ' rgb(60, 60, 60)',
		'--color-table-tr-hover': ' rgb(240, 240, 240)',
		...
		'--shadow-pagination-button-active':
			'.3rem .3rem .8rem 0rem var(--shadow-50)',
		...
		'--shadow-shadow-modal':
			' -20px 0px 15px 2px var(--shadow-05), 20px 0px 15px 2px var(--shadow-05)',
		...
		'--shadow-document':
			' -.5rem -.5rem 1.8rem 0 rgb(50, 50, 50), 1.5rem 1.5rem 1rem 0rem var(--shadow-100), inset .3rem .3rem .2rem 0 rgb(230, 230, 230), inset -.3rem -.3rem .2rem 0 rgb(150, 150, 150)',
		'--border-document-table': ' 3px solid rgb(180, 180, 180)',
	...
	return (
		<aside className={`main-sidebar ${minSidebar ? 'min-sidebar' : ''}`}>
			<div className='sidebar-header'>
				<i
					className={`arrow-sidebar fa-solid fa-angle-left ${
						minSidebar ? 'roll-back' : 'roll-forward'
					}`}
